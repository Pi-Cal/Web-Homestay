...
const RoomViewPage = () => {
  const { readRoom, roomFacility, getRentalDateByRoom } =
    ...
    <Layout>
      <div className="mt-5">
          ...
          {room.rate !== null ? (
            parseFloat(room.rate).toFixed(1) !== 0.0 ? (
              <div className="d-flex align-items-end mb-1">
                ...
                <div className="ms-2 me-2 voting-num">{`${parseFloat(
                  room.rate
                ).toFixed(1)}`}</div>
              </div>
            ) : (
        ...
        <Carousel
          ...
          variant="dark"
          prevIcon={
            <i aria-hidden="true" className="bi bi-arrow-left-circle-fill " />
          }
          nextIcon={
            <i aria-hidden="true" className="bi bi-arrow-right-circle-fill " />
          }
        >
