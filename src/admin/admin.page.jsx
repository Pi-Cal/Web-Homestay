          ...
          <Row className="gx-0">
            ...
            >
              <Nav variant="pills" className="flex-column">
                ...
                <Nav.Item>
                  <Nav.Link eventKey="room" className="text-white">
                    Room
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="facility" className="text-white">
                    Facility
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="report" className="text-white">
                    Report
                  </Nav.Link>
                </Nav.Item>
              </Nav>
...
const DenyAccess = () => {
  return (
    <Container className="100-vh 100vw fs-1 fw-bold bg-dark text-white pb-5">
      <Row className="d-flex justify-content-center align-items-center w-100 mt-5 mb-3">
