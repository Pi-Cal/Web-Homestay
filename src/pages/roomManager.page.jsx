    ...
    <HostLayout>
      <Container>
        <Row className="mb-5 banner gx-0">
          ...
          >
            <Link to="/roomsignup">
              <Button className="signup-more" variant="light">
                Đăng ký thêm
              </Button>
            </Link>
          </Col>
        ...
        <Container
          className={`room-view-choose ${isGetting ? "isGetting" : ""}`}
        >
          <button
            className={`view-type-btn${
              checkingArray[CURRENTLY_HOSTING_INDEX] ? "-choosen" : ""
            } ${isGetting ? "isGetting" : ""}`}
            onClick={handleClick}
          ...
          <button
            className={`view-type-btn${
              checkingArray[ARRIVING_SOON_INDEX] ? "-choosen" : ""
            } ${isGetting ? "isGetting" : ""}`}
            onClick={handleClick}
          ...
          <button
            className={`view-type-btn${
              checkingArray[CHECKING_OUT_INDEX] ? "-choosen" : ""
            } ${isGetting ? "isGetting" : ""}`}
            onClick={handleClick}
          ...
          <button
            className={`view-type-btn${
              checkingArray[EMPTY_INDEX] ? "-choosen" : ""
            } ${isGetting ? "isGetting" : ""}`}
            onClick={handleClick}
            id={EMPTY_INDEX}
          >{`Trống`}</button>
          <button
            className={`view-type-btn${
              checkingArray[UNCONFIRMED_INDEX] ? "-choosen" : ""
            } ${isGetting ? "isGetting" : ""}`}
            onClick={handleClick}
        ...
        </Container>
        {
          <div>
            <RoomList
              roomList={roomList}
              isEditable={checkingArray[EMPTY_INDEX]}
              isGetting={isGetting}
            />
            <WePagination
              total={totalRoom}
